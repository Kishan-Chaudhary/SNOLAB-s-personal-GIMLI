...
SensitiveDetector::SensitiveDetector(G4String name) : G4VSensitiveDetector(name), fCurrentEventID(-1), fCurrentTrackID(-1), TritonCount(0), PreviousEdepEventID(0),CurrentEdepEventID(1)
{}
...
//{
//	/*G4cout << "Initialize Sensitive Detector(BDS) for Event: " << G4RunManager::GetRunManager()->GetCurrentEvent()->GetEventID() << G4endl;*/
//    // Reset the current event and track IDs
//	TotalEdepEvent = 0;
//}
//
//
...
//{
//    G4cout << "End or Sensitive Detector(BDS) Event: " << G4RunManager::GetRunManager()->GetCurrentEvent()->GetEventID() << G4endl;
//    /*G4AnalysisManager* man = G4AnalysisManager::Instance();*/
//    if (TotalEdepEvent > 10 * keV)
//    {
//    G4cout << "Total Energy Deposition in Event: " << G4RunManager::GetRunManager()->GetCurrentEvent()->GetEventID() << " is: " << TotalEdepEvent << " MeV" << G4endl;
