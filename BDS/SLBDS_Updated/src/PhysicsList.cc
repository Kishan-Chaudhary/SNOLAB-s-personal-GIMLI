...
PhysicsList::PhysicsList()
{
  ...
  // Gamma-Nuclear Physics. Using GammaNuclearPhysicsLEND instead
  //RegisterPhysics( new GammaNuclearPhysics("Gamma"));

  // EM physics
  RegisterPhysics(new ElectromagneticPhysics());

  //Wide energy spectrum based Cross-sections
  ...
  //EM extra list (Kishan). Using GammaNuclearPhysicsLEND instead
