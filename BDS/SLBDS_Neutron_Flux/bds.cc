...
int main(int argc,char** argv) {
  ...
  UI->ApplyCommand("/run/numberOfThreads 30");
  ...
  /*UI->ApplyCommand("/control/execute FluxNeutrons.mac");*/
  //Wendt Fission Model
  //UI->ApplyCommand("/process/had/particle_hp/use_Wendt_fission_model true");
  //if (ui) {
  //    // Interactive session
  //    UI->ApplyCommand("/control/execute FluxNeutrons.mac");
  //    ui->SessionStart();  // Will show Idle>
  //    delete ui;
  //}
  //else {
  //    // Batch mode
  //    UI->ApplyCommand("/control/execute FluxNeutrons.mac");
  //}
   /*UI->ApplyCommand("/control/execute U-232.mac");*/
    UI->ApplyCommand("/control/execute Tl-208.mac");
 //ui->SessionStart();
 // delete ui;
